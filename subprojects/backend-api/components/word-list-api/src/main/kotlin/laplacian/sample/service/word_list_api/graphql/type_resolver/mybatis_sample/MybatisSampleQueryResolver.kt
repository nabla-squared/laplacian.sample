package laplacian.sample.service.word_list_api.graphql.type_resolver.mybatis_sample
...
/**
 * The root query resolver for the mybatis_sample type group.
 */
@Component
class MybatisSampleQueryResolver(
    @Qualifier("mybatis_sample.word_list.resolver")
    val wordListResolver: WordListResolver,
    @Qualifier("mybatis_sample.word.resolver")
    ...
    fun registerFetcher(wiring: RuntimeWiring.Builder): RuntimeWiring.Builder = wiring.type(
        TypeRuntimeWiring.newTypeWiring("MybatisSample")
